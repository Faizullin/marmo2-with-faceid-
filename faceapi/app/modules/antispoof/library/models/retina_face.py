...
class RetinaNet(nn.Module):
    def __init__(self):
        ...
        self.body = IntermediateLayerGetter(self.backbone, self.cfg['return_layers'])
    ...
    def to(self, *args, **kwargs):
        ...
        super(RetinaNet, self).to(*args, **kwargs)

    def load_state_dict(self, state_dict, strict: bool = ...):
        self.backbone.load_state_dict(remove_prefix(state_dict['backbone'], 'module.'), strict=strict)
        return super(RetinaNet, self).load_state_dict(remove_prefix(state_dict['header'], 'module.'), strict=strict)
